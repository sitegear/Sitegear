...
class SimpleRendererRegistryTest extends AbstractSitegearTestCase {
	...
	/**
	 * @var \Sitegear\Base\View\Renderer\Registry\SimpleRendererRegistry
	 */
	private $registry;
	...
	public function testRendering() {
		$this->assertFalse($this->registry->canRender('/anything/for/mock/renderer', $this->getMock('\\Sitegear\\Base\\View\\ViewInterface')));
		$this->assertFalse($this->registry->canRender('/do/not/render', $this->getMock('\\Sitegear\\Base\\View\\ViewInterface')));
		$this->assertNull($this->registry->render('/anything/for/mock/renderer', $this->getMock('\\Sitegear\\Base\\View\\ViewInterface')));
		$this->assertNull($this->registry->render('/do/not/render', $this->getMock('\\Sitegear\\Base\\View\\ViewInterface')));
		$this->registry->register(self::MOCK_CONTENT_RENDERER);
		$this->assertTrue($this->registry->canRender('/anything/for/mock/renderer', $this->getMock('\\Sitegear\\Base\\View\\ViewInterface')));
		$this->assertFalse($this->registry->canRender('/do/not/render', $this->getMock('\\Sitegear\\Base\\View\\ViewInterface')));
		$this->assertEquals('"/anything/for/mock/renderer" rendered by MockRenderer', $this->registry->render('/anything/for/mock/renderer', $this->getMock('\\Sitegear\\Base\\View\\ViewInterface')));
		$this->assertNull($this->registry->render('/do/not/render', $this->getMock('\\Sitegear\\Base\\View\\ViewInterface')));
	}
