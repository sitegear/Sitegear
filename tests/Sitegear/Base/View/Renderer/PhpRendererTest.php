...
class PhpRendererTest extends AbstractSitegearTestCase {
	...
	public function testRender() {
		$this->assertNotEmpty($this->renderer->render($this->fixtures() . 'site/mock/test-phtml', $this->getMock('\\Sitegear\\Base\\View\\ViewInterface')));
		$this->assertNotEmpty($this->renderer->render($this->fixtures() . 'site/mock/test-html-php', $this->getMock('\\Sitegear\\Base\\View\\ViewInterface')));
	}
	...
	public function testRenderFileNotSupported() {
		$this->renderer->render($this->fixtures() . 'site/mock/test-twig', $this->getMock('\\Sitegear\\Base\\View\\ViewInterface'));
	}
	...
	public function testRenderFileNotExists() {
		$this->renderer->render($this->fixtures() . 'site/mock/test-non-existent', $this->getMock('\\Sitegear\\Base\\View\\ViewInterface'));
	}
