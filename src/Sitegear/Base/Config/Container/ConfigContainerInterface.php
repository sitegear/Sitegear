...
interface ConfigContainerInterface {
	 ...
	 *
	 * @param \Sitegear\Base\Config\Processor\ProcessorInterface $processor Processor to add.
	 *
	 * @return self
	 */
	 ...
	 *
	 * @return \Sitegear\Base\Config\Container\ConfigContainerInterface Current object, fluent pattern.
	 *
