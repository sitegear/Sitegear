...
interface RendererRegistryInterface {
	 ...
	 *
	 * @param string|\Sitegear\Base\View\Renderer\RendererInterface|array $renderers Class name of a RendererInterface
	 ...
	 *
	 * @param string|\Sitegear\Base\View\Renderer\RendererInterface $renderers Class name of a RendererInterface implementation
	 ...
	 *
	 * @param string|\Sitegear\Base\View\Renderer\RendererInterface $renderer Class name to look for in the registry, or an
