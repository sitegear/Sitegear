...
interface DecoratorRegistryInterface {
	 ...
	 * @param null|string|\Sitegear\Base\View\Decorator\DecoratorInterface $decorator Null (or omitted) to get the
	 ...
	 *
	 * @return \Sitegear\Base\View\Decorator\DecoratorInterface Decorator with the given key, or null if it does not exist.
	 */
