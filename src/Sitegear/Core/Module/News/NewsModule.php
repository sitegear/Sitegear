...
namespace Sitegear\Core\Module\News;
...
class NewsModule extends AbstractCoreModule {
	...
	public function start() {
		$this->getEngine()->doctrine()->getEntityManager()->getConfiguration()->addEntityNamespace(self::ENTITY_ALIAS, '\\Sitegear\\Core\\Module\\News\\Model');
	}
	...
	protected function buildNavigationData($mode) {
		...
		foreach ($this->getRepository('Item')->findLatestItems($itemLimit) as $item) { /** @var \Sitegear\Core\Module\News\Model\Item $item */
			$values = array(
