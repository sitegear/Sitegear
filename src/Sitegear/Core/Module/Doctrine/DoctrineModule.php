...
class DoctrineModule extends AbstractCoreModule implements DiscreteDataModuleInterface {
	...
	public function start() {
		...
		if (!empty($connectionConfig) && is_array($connectionConfig)) {
			...
			$this->driverChain->addDriver($this->annotationDriver, 'Sitegear\Core\Module\Customer\Model');
			$this->driverChain->addDriver($this->annotationDriver, 'Sitegear\Core\Module\News\Model');
			$this->driverChain->addDriver($this->annotationDriver, 'Sitegear\Core\Module\Locations\Model');
			$this->driverChain->addDriver($this->annotationDriver, 'Sitegear\Core\Module\Products\Model');
