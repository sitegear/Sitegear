...
namespace Sitegear\Core\Module\Customer;
...
use Sitegear\Core\Module\Customer\Form\Builder\AddTrolleyItemFormBuilder;
use Sitegear\Core\Module\Customer\Form\Builder\CheckoutFormBuilder;
use Sitegear\Core\Module\Customer\Model\TransactionItem;
use Sitegear\Core\Module\Customer\Model\Account;
...
class CustomerModule extends AbstractCoreModule {
	...
	public function start() {
		...
		$this->getEngine()->doctrine()->getEntityManager()->getConfiguration()->addEntityNamespace(self::ENTITY_ALIAS, '\\Sitegear\\Core\\Module\\Customer\\Model');
