...
interface ModuleResolverInterface {
	 ...
	 *
	 * @param string|\ReflectionClass|\Sitegear\Module\ModuleInterface $module Module to get the name for.
	 *
	 ...
	 *
	 * @return string Name of a \Sitegear\Module\ModuleInterface implementation.
	 */
	 ...
	 *
	 * @return array Array of strings being names of \Sitegear\Module\BootstrapModuleInterface implementations.
	 */
